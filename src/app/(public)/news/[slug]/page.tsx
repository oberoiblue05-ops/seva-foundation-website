...
import { BLOG_POSTS } from "@/app/(public)/news/page";
...
const ARTICLE_CONTENT: Record<string, string> = {
  ...
  "sponsorship-50-children-2023": `
    ...
    <p>There are 38 children still waiting for a sponsor. It costs less than one restaurant dinner a month. <Link href="/sponsor">See the children</Link> and choose the one you want to support.</p>
  `,
  "csr-partnership-techcorp-2023": `
    ...
    <p>If your organisation is exploring CSR options for FY 2025-26, we have three Platinum slots and seven Gold slots available. Reach us at contact@sevagroupfdn.org or explore our <Link href="/csr">CSR page</Link>.</p>
  `,
};
  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        // Firebase not yet configured — show empty state gracefully
      }
    };
    load();
  }, [slug]);
